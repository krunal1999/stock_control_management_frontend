...
const UserDashBoard = () => {
  ...
  let newProductTemp = [];
  let HotSellingProductTemp = [];
  UserProductListdata.forEach((newpro) => {
    if (newpro.activestatus === "ACTIVE") {
      if (newpro.productstatus === "NEW") {
        newProductTemp.unshift(newpro);
      }else if (newpro.productstatus === "FEATURED") {
        HotSellingProductTemp.unshift(newpro);
      }
    }
  });


  newProductTemp = newProductTemp.slice(0, 3);
  HotSellingProductTemp = HotSellingProductTemp.slice(0, 3);
      ...
      <UserLayout>
        ...
        <Box sx={{ height: 700, bgcolor: "#f0f0f0" }}>
          ...
          <Stack direction="row" spacing={4}>
            {newProductTemp.map((product, index) => {
              return (
                <>
                  <Paper elevation={2}>
                    <Box
                    ...
                    >
                      ...
                      >
                        {product.productname}{" "}
                        <span style={{ color: "green" , backgroundColor:"lightgreen" , paddingLeft:2 , paddingRight:2 , borderRadius:5 , fontSize:20 }}>
        ...
        <Box sx={{ height: 700, bgcolor: "#f0f0f0" }}>
          ...
          <Stack direction="row" spacing={4}>
            {HotSellingProductTemp.map((product, index) => {
              return (
                <>
                  <Paper elevation={2}>
                    <Box
